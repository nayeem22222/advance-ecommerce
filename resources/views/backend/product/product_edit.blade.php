...
<div class="row"> <!-- start 2nd row  -->
 ...
 <option value="{{ $subsub->id }}" {{ $subsub->id == $products->subsubcategory_id ? 'selected': '' }} >{{ $subsub->subsubcategory_name_en }}</option>	
	 ...
	 @enderror
			...
			<div class="controls">
				<input type="text" name="product_name_bd" class="form-control" required=""  value="{{ $products->product_name_bd }}">
     @error('product_name_bd') 
	 <span class="text-danger">{{ $message }}</span>
	 @enderror
	 		 </div>
		</div>
...
<div class="row"> <!-- start 4th row  -->
	    ...
	    <div class="form-group">
			...
			<div class="controls">
	 <input type="text" name="product_tags_bd" class="form-control" value="{{ $products->product_tags_bd }}" data-role="tagsinput" required="">
     @error('product_tags_bd') 
	 <span class="text-danger">{{ $message }}</span>
	 @enderror
	 		 </div>
		</div>
	 ...
	 @enderror
			...
			<div class="controls">
	 <input type="text" name="product_size_bd" class="form-control" value="{{ $products->product_size_bd }}" data-role="tagsinput"  >
     @error('product_size_bd') 
	 <span class="text-danger">{{ $message }}</span>
	 @enderror
	 		 </div>
		</div>
...
<div class="row"> <!-- start 5th row  -->
	 ...
	 @enderror
			...
			<div class="controls">
	 <input type="text" name="product_color_bd" class="form-control" value="{{ $products->product_color_bd }}" data-role="tagsinput" required="">
     @error('product_color_bd') 
	 <span class="text-danger">{{ $message }}</span>
	 @enderror
	 		 </div>
		</div>
	...
	<textarea name="short_descp_en" id="textarea" class="form-control" required placeholder="Textarea text">
		{!! $products->short_descp_en !!}
	     ...
	     <div class="form-group">
			...
			<div class="controls">
	<textarea name="short_descp_bd" id="textarea" class="form-control" required placeholder="Textarea text">
		{!! $products->short_descp_bd !!}
	</textarea>     
	 		 </div>
		</div>
